...
const vehicleSchema = new mongoose.Schema({
    ...
    body_type: {
        type: String,
        enum: ['Sedan', 'SUV', 'Crossover', 'Hatchback', 'Coupe', 'MPV', 'Pickup', 'Sports', 'Wagon', 'Other'],
    },
    segment: { type: String },
    ...
    specs: {
        ...
        charging: {
            ...
            dc_speed_km_15min: Number,
            plug_and_charge: Boolean,
            v2l_support: Boolean,
            v2l_max_power_kw: Number,
            v2h_support: Boolean,
            v2g_support: Boolean,
            v2v_support: Boolean,
        },
        ...
        powertrain: {
            ...
            front_motor_power_hp: Number,
            rear_motor_type: String,
            rear_motor_power_hp: Number,
        ...
        dimensions_and_weight: {
            ...
            trunk_liters: Number,
            trunk_max_liters: Number,
            frunk_liters: Number,
            frunk_powered: Boolean,
            roof_load_kg: Number,
        ...
        cockpit_and_tech: {
            ...
            hud: String,
            passenger_screen_inches: Number,
            rear_screens: String,
        ...
        adas_and_safety: {
            ...
            euro_ncap_adult_pct: Number,
            euro_ncap_child_pct: Number,
            nhtsa_stars: Number,
            airbag_count: Number,
            autonomy_level: String,
            adas_system_name: String,
            adas_compute_chip: String,
            lidar_count: Number,
            camera_count: Number,
            radar_count: Number,
    ...
    pricing: {
        ...
        customs_duty_rate_pct: Number,
        sales_tax_rate_pct: Number,
        token_tax_annual_pkr: Number,
        included_home_charger: String,
        charging_adapter_included: String,
